...
echo "POST invoke chaincode: issue on peers of Org1 and Org2"
echo
TRX_ID=$(curl -s -X POST \
  ...
  -d '{
	...
	"fcn":"issue",
	"args":["{\"BillInfoID\":\"POC10000000\",\"BillInfoAmt\":\"1000000\",\"BillInfoType\":\"111\",\"BillInfoIsseDate\":\"20180606\",\"BillInfoDueDate\":\"20190101\",\"DrwrCmID\":\"111\",\"DrwrAcct\":\"111\",\"AccptrCmID\":\"111\",\"AccptrAcct\":\"111\",\"PyeeCmID\":\"111\",\"PyeeAcct\":\"111\",\"HodrCmID\":\"ACMID\",\"HodrAcct\":\"A\"}"]
}')
TRX_ID=$(echo $TRX_ID | jq ".message" | sed "s/\"//g")
echo "Transaction ID is $TRX_ID"
echo
echo

echo "POST invoke chaincode: accept on peer1 of Org1"
echo
TRX_ID=$(curl -s -X POST \
  http://localhost:4000/channels/mychannel/chaincodes/mycc \
  -H "authorization: Bearer $ORG1_TOKEN" \
